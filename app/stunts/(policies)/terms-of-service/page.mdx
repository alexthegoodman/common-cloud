...
Welcome to Stunts ("Service"), operated by Common ("we," "our," "us"). By accessing or using our Service, you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these Terms, you do not have permission to access the Service.

## 2. Definitions

- "Service" refers to the Stunts software, website, and related services
