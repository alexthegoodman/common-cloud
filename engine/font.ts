...
export class FontManager {
  ...
  constructor() {
    ...
    this.fontData = [
      ...
      {
        name: "Baloo2",
        path: "/fonts/baloo2/Baloo2[wght].ttf",
        style: "Regular",
        support: ["devanagari"],
      },
      {
        name: "Cambay",
        path: "/fonts/cambay/Cambay-Regular.ttf",
        style: "Regular",
        support: ["devanagari"],
      },
      {
        name: "IBM Plex Mono",
        path: "/fonts/ibmplexmono/IBMPlexMono-Regular.ttf",
        style: "Regular",
        support: ["devanagari"],
      },
      {
        name: "Karma",
        path: "/fonts/karma/Karma-Regular.ttf",
        style: "Regular",
        support: ["devanagari"],
      },
      {
        name: "Noto Sans Devanagari",
        path: "/fonts/notosansdevanagari/NotoSansDevanagari[wdth,wght].ttf",
        style: "Regular",
        support: ["devanagari"],
      },
    ];
